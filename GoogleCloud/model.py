...
import os
inFile = open('/tmp/requirements.txt')
for line in inFile:
	os.system('sudo apt-get install -y ${line}')
...
train_loc = "/tmp/iris_train.csv"
test_loc = "/tmp/iris_test.csv"
...
txt_path = "/tmp/prediction_accuracy.txt"
